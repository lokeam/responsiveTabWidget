(function(w,d){
    var 
        ...
        baseurl = "http://townsquaredigital.com/lineup-widget/",
    	html = "<!doctype html>"+
"<html>"+
    "<head>"+
        "<meta charset='utf-8'>"+
        ...
        "<link rel='stylesheet' type='text/css' href='css/dist/styles.css'>"+
    ...
    "<body class='content-wrap'>"+
        ...
        "</script>"+
		"<script type='text/javascript' src='js/dist/hb.dev.js'></script>"+
        "<script type='text/javascript' src='js/dist/lineupwidget.dev.js'></script>"+
    "</body>"+
"</html>",
