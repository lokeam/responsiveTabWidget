(function(w,d,$){
	...
	var lineupwWidget = {
		...
		buildTab: function(allRender) {
			...
			// Begin HB test
			console.log('======>about to do things with Handlebars');
			var hbtestTemplate = $('#hbtest').html(),
				hbtestContent = {"relation" : "time", "animal" : "walrus"};
				//hbtestTemplate = parent;

			var hbtestTemplateScript = Handlebars.compile(hbtestTemplate);
			var hbtestHTML = hbtestTemplateScript(hbtestContent);
			console.log('testing hbtestHTML: ', hbtestHTML);



			// 	"In a zoo, sometimes you have to jerk off a couple of elephants"
			// 	 -YFT 2017

			$('#hbtest').append(hbtestHTML);
			console.log('****finished doing things with Handlebars');
			// End HB test
