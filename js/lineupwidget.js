(function(w,d,$){
	...
	var lineupwWidget = {
		...
		setEmbedStyles: function(embedSettings) {
			...
			".artists .artistSlot .artistInfo, .artists .artistSlot .artistInfo p, .customArtistButtonTextRoot, .customArtistButtonText, .artistShare a p, .widgetMessage, .dl-submenu .artistInfo p span.artistPlace, .dl-submenu .artistInfo p span.artistPlace {color: "+embedSettings.artistCopyColor+"}"+
